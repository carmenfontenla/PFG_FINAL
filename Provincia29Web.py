...
df_provincia29['y'] = df_provincia29['count']
df_provincia29['ds'] = pd.to_datetime(pd.to_datetime(df_provincia29['FECHA']).dt.date)

ts = df_provincia29[['ds', 'y']]
model = Prophet(
...
df_provincia29['y'] = df_provincia29['TOTAL_VICTIMAS_24H']
df_provincia29['ds'] = pd.to_datetime(pd.to_datetime(df_provincia29['FECHA']).dt.date)
