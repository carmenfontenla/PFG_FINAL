...
df_provincia25['y'] = df_provincia25['count']
df_provincia25['ds'] = pd.to_datetime(pd.to_datetime(df_provincia25['FECHA']).dt.date)

ts = df_provincia25[['ds', 'y']]
model = Prophet(
...
df_provincia25['y'] = df_provincia25['TOTAL_VICTIMAS_24H']
df_provincia25['ds'] = pd.to_datetime(pd.to_datetime(df_provincia25['FECHA']).dt.date)
