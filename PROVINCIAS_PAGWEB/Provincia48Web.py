...
db_provincia48 = df[df['COD_PROVINCIA'] == 48]
...
df_provincia48 = df_provincia48[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia48.sort_values(by='FECHA')

df_provincia48.to_csv('./BBDD/Provincia48.csv')
...
# load dataset
values = df_provincia48['TOTAL_VICTIMAS_24H'].values
...
with open('MODELOS/model_Provincia48_Victimas.pkl', 'wb') as file:
    pickle.dump(model_v, file)

with open('MODELOS/scaler_Provincia48_Victimas.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_v.save_weights('MODELOS/victimas_Provincia48.weights.h5')