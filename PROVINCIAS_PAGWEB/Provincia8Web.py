...
db_provincia8 = df[df['COD_PROVINCIA'] == 8]
...
df_provincia8.sort_values(by='FECHA')

df_provincia8.to_csv('./BBDD/Provincia8.csv')
...
# load dataset
values = df_provincia8['TOTAL_VICTIMAS_24H'].values
