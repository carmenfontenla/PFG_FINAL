...
db_provincia47 = df[df['COD_PROVINCIA'] == 47]
...
df_provincia47.sort_values(by='FECHA')

df_provincia47.to_csv('./BBDD/Provincia47.csv')
...
with open('MODELOS/scaler_Provincia47_Victimas.sav', 'wb') as file:
