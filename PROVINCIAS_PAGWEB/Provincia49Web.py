...
db_provincia49 = df[df['COD_PROVINCIA'] == 49]
...
df_provincia49 = df_provincia49[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia49.sort_values(by='FECHA')

df_provincia49.to_csv('./BBDD/Provincia49.csv')
...
# load dataset
values = df_provincia49['count'].values
...
with open('MODELOS/model_Provincia49_Accidentes.pkl', 'wb') as file:
    pickle.dump(model_a, file)

with open('MODELOS/scaler_Provincia49_Accidentes.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_a.save_weights('MODELOS/accidentes_Provincia49.weights.h5')
