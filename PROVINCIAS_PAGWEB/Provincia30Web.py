...
df_provincia30.sort_values(by='FECHA')

df_provincia30.to_csv('./BBDD/Provincia30.csv')
...
with open('MODELOS/model_Provincia30_Accidentes.pkl', 'wb') as file:
    pickle.dump(model_a, file)  

# VÍCTIMAS

df_provincia30['y'] = df_provincia30['TOTAL_VICTIMAS_24H']
df_provincia30['ds'] = pd.to_datetime(pd.to_datetime(df_provincia30['FECHA']).dt.date)
...
with open('MODELOS/model_Provincia30_Victimas.pkl', 'wb') as file:
