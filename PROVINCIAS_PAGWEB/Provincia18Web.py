...
db_provincia18 = df[df['COD_PROVINCIA'] == 18]
...
df_provincia18 = df_provincia18[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia18.sort_values(by='FECHA')

df_provincia18.to_csv('./BBDD/Provincia18.csv')
...
# load dataset
values = df_provincia18['count'].values
...
with open('MODELOS/model_Provincia18_Accidentess.pkl', 'wb') as file:
    pickle.dump(model_a, file)

with open('MODELOS/scaler_Provincia18_Accidentes.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_a.save_weights('MODELOS/accidentes_Provincia18.weights.h5')

# VÍCTIMAS

df_provincia18['y'] = df_provincia18['TOTAL_VICTIMAS_24H']
df_provincia18['ds'] = pd.to_datetime(pd.to_datetime(df_provincia18['FECHA']).dt.date)

ts = df_provincia18[['ds', 'y']]
model_v = Prophet(
...
with open('MODELOS/model_Provincia18_Victimas.pkl', 'wb') as file:
