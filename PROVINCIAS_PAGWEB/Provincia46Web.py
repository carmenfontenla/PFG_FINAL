...
df_provincia46.sort_values(by='FECHA')

df_provincia46.to_csv('./BBDD/Provincia46.csv')
...
with open('MODELOS/model_Provincia46_Accidentes.pkl', 'wb') as file:
...
with open('MODELOS/model_Provincia46_Victimas.pkl', 'wb') as file:
    pickle.dump(model_v, file)

with open('MODELOS/scaler_Provincia46_Victimas.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_v.save_weights('MODELOS/victimas_Provincia46.weights.h5')