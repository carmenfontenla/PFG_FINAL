...
db_provincia21 = df[df['COD_PROVINCIA'] == 21]
...
df_provincia21 = df_provincia21[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia21.sort_values(by='FECHA')

df_provincia21.to_csv('./BBDD/Provincia21.csv')
...
# load dataset
values = df_provincia21['TOTAL_VICTIMAS_24H'].values
...
with open('MODELOS/model_Provincia21_Victimas.pkl', 'wb') as file:
    pickle.dump(model_v, file)

with open('MODELOS/scaler_Provincia21_Victimas.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_v.save_weights('MODELOS/victimas_Provincia21.weights.h5')