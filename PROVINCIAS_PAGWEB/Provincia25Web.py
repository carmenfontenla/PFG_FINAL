...
db_provincia25 = df[df['COD_PROVINCIA'] == 25]
...
df_provincia25.sort_values(by='FECHA')

df_provincia25.to_csv('./BBDD/Provincia25.csv')
...
# load dataset
values = df_provincia25['count'].values
...
with open('MODELOS/model_Provincia25_Accidentess.pkl', 'wb') as file:
    pickle.dump(model_a, file)

with open('MODELOS/scaler_Provincia25_Accidentes.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_a.save_weights('MODELOS/accidentes_Provincia25.weights.h5')
