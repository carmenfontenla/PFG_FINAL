...
db_provincia14 = df[df['COD_PROVINCIA'] == 14]
...
df_provincia14 = df_provincia14[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia14.sort_values(by='FECHA')

df_provincia14.to_csv('./BBDD/Provincia14.csv')
...
# load dataset
values = df_provincia14['count'].values
...
with open('MODELOS/model_Provincia14_Accidentess.pkl', 'wb') as file:
    pickle.dump(model_a, file)

with open('MODELOS/scaler_Provincia14_Accidentes.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_a.save_weights('MODELOS/accidentes_Provincia14.weights.h5')
