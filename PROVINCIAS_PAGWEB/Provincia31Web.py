...
db_provincia31 = df[df['COD_PROVINCIA'] == 31]
...
df_provincia31 = df_provincia31[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia31.sort_values(by='FECHA')

df_provincia31.to_csv('./BBDD/Provincia31.csv')
...
# load dataset
values = df_provincia31['TOTAL_VICTIMAS_24H'].values
...
with open('MODELOS/model_Provincia31_Victimas.pkl', 'wb') as file:
    pickle.dump(model_v, file)

with open('MODELOS/scaler_Provincia31_Victimas.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_v.save_weights('MODELOS/victimas_Provincia31.weights.h5')