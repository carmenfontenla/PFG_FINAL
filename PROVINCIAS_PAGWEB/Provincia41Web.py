...
df_provincia41.sort_values(by='FECHA')

df_provincia41.to_csv('./BBDD/Provincia41.csv')

# ACCIDENTES

df_provincia41['y'] = df_provincia41['count']
df_provincia41['ds'] = pd.to_datetime(pd.to_datetime(df_provincia41['FECHA']).dt.date)

ts = df_provincia41[['ds', 'y']]
model_a = Prophet(
...
with open('MODELOS/model_Provincia41_Accidentes.pkl', 'wb') as file:
    pickle.dump(model_a, file)  

# VÍCTIMAS

df_provincia41['y'] = df_provincia41['TOTAL_VICTIMAS_24H']
df_provincia41['ds'] = pd.to_datetime(pd.to_datetime(df_provincia41['FECHA']).dt.date)
...
with open('MODELOS/model_Provincia41_Victimas.pkl', 'wb') as file:
