...
db_provincia10 = df[df['COD_PROVINCIA'] == 10]
...
df_provincia10 = df_provincia10[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

df_provincia10.sort_values(by='FECHA')

df_provincia10.to_csv('./BBDD/Provincia10.csv')
...
# load dataset
values = df_provincia10['TOTAL_VICTIMAS_24H'].values
...
with open('MODELOS/model_Provincia10_Victimas.pkl', 'wb') as file:
    pickle.dump(model_v, file)

with open('MODELOS/scaler_Provincia10_Victimas.sav', 'wb') as file:
    pickle.dump(scaler, file)

model_v.save_weights('MODELOS/victimas_Provincia10.weights.h5')