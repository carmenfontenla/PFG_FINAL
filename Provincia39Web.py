...
df_provincia39['y'] = df_provincia39['count']
df_provincia39['ds'] = pd.to_datetime(pd.to_datetime(df_provincia39['FECHA']).dt.date)

ts = df_provincia39[['ds', 'y']]
model = Prophet(
...
df_provincia39['y'] = df_provincia39['TOTAL_VICTIMAS_24H']
df_provincia39['ds'] = pd.to_datetime(pd.to_datetime(df_provincia39['FECHA']).dt.date)
