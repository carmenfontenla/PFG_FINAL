...
df_provincia10['y'] = df_provincia10['count']
df_provincia10['ds'] = pd.to_datetime(pd.to_datetime(df_provincia10['FECHA']).dt.date)

ts = df_provincia10[['ds', 'y']]
model = Prophet(
...
df_provincia10['y'] = df_provincia10['TOTAL_VICTIMAS_24H']
df_provincia10['ds'] = pd.to_datetime(pd.to_datetime(df_provincia10['FECHA']).dt.date)
