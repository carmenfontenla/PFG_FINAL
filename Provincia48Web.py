...
df_provincia48['y'] = df_provincia48['count']
df_provincia48['ds'] = pd.to_datetime(pd.to_datetime(df_provincia48['FECHA']).dt.date)

ts = df_provincia48[['ds', 'y']]
model = Prophet(
...
df_provincia48['y'] = df_provincia48['TOTAL_VICTIMAS_24H']
df_provincia48['ds'] = pd.to_datetime(pd.to_datetime(df_provincia48['FECHA']).dt.date)
