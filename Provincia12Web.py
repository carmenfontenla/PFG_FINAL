...
df_provincia12['y'] = df_provincia12['count']
df_provincia12['ds'] = pd.to_datetime(pd.to_datetime(df_provincia12['FECHA']).dt.date)

ts = df_provincia12[['ds', 'y']]
model = Prophet(
...
df_provincia12['y'] = df_provincia12['TOTAL_VICTIMAS_24H']
df_provincia12['ds'] = pd.to_datetime(pd.to_datetime(df_provincia12['FECHA']).dt.date)
