...
df_provincia31['y'] = df_provincia31['count']
df_provincia31['ds'] = pd.to_datetime(pd.to_datetime(df_provincia31['FECHA']).dt.date)

ts = df_provincia31[['ds', 'y']]
model = Prophet(
...
df_provincia31['y'] = df_provincia31['TOTAL_VICTIMAS_24H']
df_provincia31['ds'] = pd.to_datetime(pd.to_datetime(df_provincia31['FECHA']).dt.date)
