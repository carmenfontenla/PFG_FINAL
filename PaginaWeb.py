...
modelos_provincias_victimas = {
    1:('model_Provincia1_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia1.csv'),
    2:('model_Provincia2_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia2.csv'),
    3:('model_Provincia3_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia3.csv'),
    4:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia4.csv'),
    5:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia5.csv'),
    6:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia6.csv'),
    7:('model_Provincia7_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia7.csv'),
    8:('model_Provincia8_Victimas.pkl', 'RN', 'scaler_Provincia8_Victimas.sav', 'victimas_Provincia8.weights.h5', '07/12/2020', 'Provincia8.csv'),
    9:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia9.csv'),
    10:('model_Provincia10_Victimas.pkl', 'RN', 'scaler_Provincia10_Victimas.sav', 'victimas_Provincia10.weights.h5', '07/12/2020', 'Provincia10.csv'),
    11:('model_Provincia11_Victimas.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia11.csv'),
    12:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia12.csv'),
    13:(0, 'No existe', 0, 0, '06/12/2020', 'Provincia13.csv'),
    14:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia14.csv'),
    15:('model_Provincia15_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia15.csv'),
    16:(0, 'No existe', 0, 0, '05/12/2020', 'Provincia16.csv'),
    17:('model_Provincia17_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia17.csv'),
    18:('model_Provincia18_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia18.csv'),
    19:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia19.csv'),
    20:('model_Provincia20_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia20.csv'),
    21:('model_Provincia21_Victimas.pkl', 'RN', 'scaler_Provincia21_Victimas.sav', 'victimas_Provincia21.weights.h5', '07/12/2020', 'Provincia21.csv'),
    22:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia22.csv'),
    23:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia23.csv'),
    24:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia24.csv'),
    25:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia25.csv'),
    26:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia26.csv'),
    27:(0, 'No existe', 0, 0, '06/12/2020', 'Provincia27.csv'),    
    28:('model_Provincia28_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia28.csv'),
    29:('model_Provincia29_Victimas.pkl', 'RN', 'scaler_Provincia29_Victimas.sav', 'victimas_Provincia29.weights.h5', '07/12/2020', 'Provincia29.csv'),
    30:('model_Provincia30_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia30.csv'),
    31:('model_Provincia31_Victimas.pkl', 'RN', 'scaler_Provincia31_Victimas.sav', 'victimas_Provincia31.weights.h5', '07/12/2020', 'Provincia31.csv'),
    32:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia32.csv'),    
    33:('model_Provincia33_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia33.csv'),
    34:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia34.csv'),    
    35:('model_Provincia35_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia35.csv'),
    36:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia36.csv'),    
    37:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia37.csv'),    
    38:('model_Provincia38_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia38.csv'),
    39:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia39.csv'),    
    40:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia40.csv'),    
    41:('model_Provincia41_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia41.csv'),
    42:(0, 'No existe', 0, 0, '05/12/2020', 'Provincia42.csv'),  
    43:('model_Provincia43_Victimas.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia43.csv'),  
    44:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia44.csv'),    
    45:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia45.csv'),    
    46:('model_Provincia46_Victimas.pkl', 'RN', 'scaler_Provincia46_Victimas.sav', 'victimas_Provincia46.weights.h5', '07/12/2020', 'Provincia46.csv'),
    47:('model_Provincia47_Victimas.pkl', 'RN', 'scaler_Provincia47_Victimas.sav', 'victimas_Provincia47.weights.h5', '07/12/2020', 'Provincia47.csv'),
    48:('model_Provincia48_Victimas.pkl', 'RN', 'scaler_Provincia48_Victimas.sav', 'victimas_Provincia48.weights.h5', '07/12/2020', 'Provincia48.csv'),
    49:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia49.csv'),
    50:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia50.csv'), 
    51:(0, 'No existe', 0, 0, '06/12/2020', 'Provincia51.csv'),
    52:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia52.csv')
}

@app.route('/resultado', methods = ['POST'])
#(modelo pkl, tipo de modelo, scaler, pesos, ultima fecha, dataset de provincia)
def resultado():
    if request.method == 'POST':
        predict_list = request.form.to_dict()
        predict_list = list(predict_list.values())
        try:
            datos_provincia_accidentes = modelos_provincias_accidentes[int(predict_list[1])]
        ...
        print(resultado_accidentes)
        print(resultado)
        print(resultado_victimas)
    return render_template('resultados.html', prediction1 = resultado, prediction2 = resultado_accidentes, prediction3 = resultado_victimas)
