...
modelos_provincias_victimas = {
    1:('model_Provincia1_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia1.csv'),
    2:('model_Provincia2_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia2.csv'),
    3:('model_Provincia3_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia3.csv'),
    4:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia4.csv'),
    5:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia5.csv'),
    6:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia6.csv'),
    7:('model_Provincia7_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia7.csv'),
    8:('model_Provincia8_Accidentes.pkl', 'RN', 'scaler_Provincia8_accidentes.sav', 'accidentes_Provincia8.weights.h5', '07/12/2020', 'Provincia8.csv'),
    9:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia9.csv'),
    10:('model_Provincia10_Accidentes.pkl', 'RN', 'scaler_Provincia10_accidentes.sav', 'accidentes_Provincia10.weights.h5', '07/12/2020', 'Provincia10.csv'),
    ...
    16:(0, 'No existe', 0, 0, '05/12/2020', 'Provincia16.csv'),
    17:('model_Provincia17_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia17.csv'),
    18:('model_Provincia18_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia18.csv'),
    19:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia19.csv'),
    20:('model_Provincia20_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia20.csv'),
    21:('model_Provincia21_Accidentes.pkl', 'RN', 'scaler_Provincia21_accidentes.sav', 'accidentes_Provincia21.weights.h5', '07/12/2020', 'Provincia21.csv'),
    22:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia22.csv'),
    ...
    27:(0, 'No existe', 0, 0, '06/12/2020', 'Provincia27.csv'),    
    28:('model_Provincia28_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia28.csv'),
    29:('model_Provincia29_Accidentes.pkl', 'RN', 'scaler_Provincia29_accidentes.sav', 'accidentes_Provincia29.weights.h5', '07/12/2020', 'Provincia29.csv'),
    30:('model_Provincia30_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia30.csv'),
    31:('model_Provincia31_Accidentes.pkl', 'RN', 'scaler_Provincia31_accidentes.sav', 'accidentes_Provincia31.weights.h5', '07/12/2020', 'Provincia31.csv'),
    32:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia32.csv'),    
    33:('model_Provincia33_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia33.csv'),
    34:(0, 'No existe', 0, 0, '07/12/2020', 'Provincia34.csv'),    
    35:('model_Provincia35_Accidentes.pkl', 'PROPHET', 0, 0, '07/12/2020', 'Provincia35.csv'),
    ...
    46:('model_Provincia46_Accidentes.pkl', 'RN', 'scaler_Provincia46_accidentes.sav', 'accidentes_Provincia46.weights.h5', '07/12/2020', 'Provincia46.csv'),
    47:('model_Provincia47_Accidentes.pkl', 'RN', 'scaler_Provincia47_accidentes.sav', 'accidentes_Provincia47.weights.h5', '07/12/2020', 'Provincia47.csv'),
    48:('model_Provincia48_Accidentes.pkl', 'RN', 'scaler_Provincia48_accidentes.sav', 'accidentes_Provincia48.weights.h5', '07/12/2020', 'Provincia48.csv'),
