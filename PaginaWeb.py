...
modelos_provincias_accidentes = {
    ...
    2:('model_Provincia2_Accidentes.pkl', 'RN', 'scaler_Provincia2_accidentes.sav', 'accidentes_Provincia2.weights.h5', '07/09/2020', 'Provincia2.csv'),
    3:('model_Provincia3_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia4.csv'),
    ...
    8:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia8.csv'),
    9:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia9.csv'),
    10:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia10.csv'),
    11:('model_Provincia11_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia11.csv'),
    12:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia12.csv'),
    13:(0, 'No existe', 0, 0, '07/9/2020', 'Provincia13.csv'),
    14:('model_Provincia14_Accidentes.pkl', 'RN', 'scaler_Provincia14_accidentes.sav', 'accidentes_Provincia14.weights.h5', '07/09/2020', 'Provincia4.csv'),
    ...
    18:('model_Provincia18_Accidentes.pkl', 'RN', 'scaler_Provincia18_accidentes.sav', 'accidentes_Provincia18.weights.h5', '07/09/2020', 'Provincia18.csv'),
    19:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia19.csv'),
    20:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia20.csv'),
    21:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia21.csv'),
    22:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia22.csv'),
    23:('model_Provincia23_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia23.csv'),
    24:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia24.csv'),
    25:('model_Provincia25_Accidentes.pkl', 'RN', 'scaler_Provincia25_accidentes.sav', 'accidentes_Provincia25.weights.h5', '07/09/2020', 'Provincia25.csv'),
    26:('model_Provincia26_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia26.csv'),
    27:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia27.csv'),    
    28:('model_Provincia28_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia28.csv'),
    29:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia29.csv'),
    30:('model_Provincia30_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia30.csv'),
    31:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia31.csv'),
    ...
    36:('model_Provincia36_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia36.csv'),
    37:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia37.csv'),    
    38:('model_Provincia38_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia38.csv'),
    39:('model_Provincia39_Accidentes.pkl', 'RN', 'scaler_Provincia39_accidentes.sav', 'accidentes_Provincia39.weights.h5', '07/09/2020', 'Provincia39.csv'),
    ...
    45:('model_Provincia45_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia45.csv'),
    46:('model_Provincia46_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia46.csv'),
    47:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia47.csv'),
    48:(0, 'No existe', 0, 0, '07/09/2020', 'Provincia48.csv'), 
    49:('model_Provincia49_Accidentes.pkl', 'RN', 'scaler_Provincia49_accidentes.sav', 'accidentes_Provincia49.weights.h5', '07/09/2020', 'Provincia49.csv'),
    50:('model_Provincia50_Accidentes.pkl', 'PROPHET', 0, 0, '07/09/2020', 'Provincia50.csv'),
