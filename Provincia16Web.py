...
df_provincia16['y'] = df_provincia16['count']
df_provincia16['ds'] = pd.to_datetime(pd.to_datetime(df_provincia16['FECHA']).dt.date)

ts = df_provincia16[['ds', 'y']]
model = Prophet(
...
df_provincia16['y'] = df_provincia16['TOTAL_VICTIMAS_24H']
df_provincia16['ds'] = pd.to_datetime(pd.to_datetime(df_provincia16['FECHA']).dt.date)
