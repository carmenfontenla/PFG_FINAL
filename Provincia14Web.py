...
df_provincia14['y'] = df_provincia14['count']
df_provincia14['ds'] = pd.to_datetime(pd.to_datetime(df_provincia14['FECHA']).dt.date)

ts = df_provincia14[['ds', 'y']]
model = Prophet(
...
df_provincia14['y'] = df_provincia14['TOTAL_VICTIMAS_24H']
df_provincia14['ds'] = pd.to_datetime(pd.to_datetime(df_provincia14['FECHA']).dt.date)
