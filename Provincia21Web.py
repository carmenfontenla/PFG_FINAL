...
df_provincia21['y'] = df_provincia21['count']
df_provincia21['ds'] = pd.to_datetime(pd.to_datetime(df_provincia21['FECHA']).dt.date)

ts = df_provincia21[['ds', 'y']]
model = Prophet(
...
df_provincia21['y'] = df_provincia21['TOTAL_VICTIMAS_24H']
df_provincia21['ds'] = pd.to_datetime(pd.to_datetime(df_provincia21['FECHA']).dt.date)
