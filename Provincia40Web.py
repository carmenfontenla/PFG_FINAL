...
df_provincia4 = df_provincia40[['ANYO_x', 'FECHA', 'count', 'TOTAL_VICTIMAS_24H']]

# ACCIDENTES

df_provincia40['y'] = df_provincia40['count']
df_provincia40['ds'] = pd.to_datetime(pd.to_datetime(df_provincia40['FECHA']).dt.date)

ts = df_provincia40[['ds', 'y']]
model = Prophet(
...
df_provincia40['y'] = df_provincia40['TOTAL_VICTIMAS_24H']
df_provincia40['ds'] = pd.to_datetime(pd.to_datetime(df_provincia40['FECHA']).dt.date)
