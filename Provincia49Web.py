...
df_provincia49['y'] = df_provincia49['count']
df_provincia49['ds'] = pd.to_datetime(pd.to_datetime(df_provincia49['FECHA']).dt.date)

ts = df_provincia49[['ds', 'y']]
model = Prophet(
...
df_provincia49['y'] = df_provincia49['TOTAL_VICTIMAS_24H']
df_provincia49['ds'] = pd.to_datetime(pd.to_datetime(df_provincia49['FECHA']).dt.date)
